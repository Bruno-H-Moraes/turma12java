programa
{
	...
	funcao inicio()
	{
		...
		faca{
			...
			escreva ("\nInforme a decisão do time 1 - (V - vitória) - (E - empate) - (D - derrota): ")
			leia (c)
			escreva ("\nInforme a decisão do time 2 - (V - vitória) - (E - empate) - (D - derrota): ")
			leia (p)
			escreva ("\nInforme a decisão do time 3 - (V - vitória) - (E - empate) - (D - derrota): ")
			leia (spfc)
			escreva ("\nInforme a decisão do time 4 - (V - vitória) - (E - empate) - (D - derrota): ")
			leia (san)
			// corinthians
			se (c == "V" ou c == "v")
			{
